...
import { connectToMongo, client } from "./Database.js"; // import client too
...
app.get("/book", async (req, res) => {
  try {
    ...
    // If category is passed as query param, filter by it
    ...
    // Send detailed error message if something goes wrong
    res.status(500).send({
